...
export default function ProgressPanel({
  ...
  return (
    <div className="rounded-xl border border-amber-500/35 bg-amber-500/10 px-3 py-3 text-xs text-amber-100">
      ...
      <div className="mt-2 flex flex-wrap gap-x-4 gap-y-1 text-[11px] text-amber-100/90">
      ...
      {extraInfo ? <p className="mt-1 text-[11px] text-amber-200/90">{extraInfo}</p> : null}
    </div>
  );
}
